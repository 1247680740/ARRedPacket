...
(function (views) {
    ...
    var TestScene = /** @class */ (function () {
        ...
        TestScene.prototype.dataInit = function () {
         ...
         * 不用系统的机型进行不同的场景适配
         */
        TestScene.prototype.createAdapter = function () {
            if (laya.utils.Browser.onAndriod) {
                //创建摄像机(横纵比，近距裁剪，远距裁剪)-----
        ...
        TestScene.prototype.changeCamera = function (camera) {
            if (laya.utils.Browser.onAndriod) {
        ...
        TestScene.resetCamera = function () {
            if (laya.utils.Browser.onAndriod) {
        ...
        TestScene.prototype.onMotoin = function (absolute, rotationInfo) {
            this.monTex.text =
        ...
        //连接服务器
        TestScene.prototype.connetService = function () {
            var pfObj;
        ...
        TestScene.prototype.onCreateComplete = function () {
            //添加狗的动画模型
        ...
        TestScene.prototype.createObj = function (i) {
        ...
        TestScene.prototype.jihe = function (gift) {
        ...
        */
        TestScene.prototype.onShoot = function (event) {
            // alert("点击目标："+event.target.parent.name); 
         ...
         * 更改动画
         */
        TestScene.changeAni = function (obj) {
         ...
         * 显示点击红包界面
         */
        TestScene.giftUI = function (name) {
        ...
        TestScene.resetBG = function (name) {
        ...
        /** 狗的模型 */
        TestScene.layaDog = null;
        TestScene.Gyro = true;
        TestScene.isShoot = false;
        TestScene.giftOpen = false;
        return TestScene;
    }());
    views.TestScene = TestScene;
})(views || (views = {}));
